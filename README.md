An MS/Ph.D. student with experience in biochemistry and molecular genetics in _Drosophila melanogaster_, now focusing on synthetic biology and genomics in _C. elegans_. Contributed to **standardized _C. elegans_ neuron-specific enhancer/promoter pool** (paper in draft) in [WormBuilder](https://wormbuilder.org/transgenebuilder/), and co-developed [wormdigester](https://github.com/JeromeeX/wormdigester) (unpublished), a tool illustrating _C. elegans_ genomic fragment length distribution after _in silico_ digestion by common endonucleases, currently developing a novel **target-enrichment sequencing strategy**.
